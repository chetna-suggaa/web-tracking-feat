...
const MapContainer = withScriptjs(withGoogleMap(() => {
  return (
    ...
    <div className='ride_status-container'>
      <h2 name="ride_status">Ongoing</h2>
    </div>
    <div className='route_details-conatiner'>
      <div className='Orgin-container'>Tupudana,Hatia,Ranchi</div>
      <div className='spacer'></div>
      <div className='destination-container'>Mecon colony ,Doranda,Ranchi</div>
      ...
      <div className='left-container'>
        ...
        <div className='Rating'>
          ...
          <div className='right-container'>
            <div className='Driver_Name'>driver_name</div>
            <div className='Vehicle_info'>
              <div className='vehicle_model'>swift</div>
              <div className='vehicle_number'>JH058923</div>
            </div>
